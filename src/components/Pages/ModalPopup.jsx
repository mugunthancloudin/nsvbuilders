                ...
                <div className="col-md-9 col-sm-8">
                  ...
                  <div className="row">
                    <div className="button-model col-md-3 col-sm-6">
                      ...
                      >
                        <img
                          src={require("./../../images/gallery/pic1.jpeg")}
                          alt=""
                        />
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <p>
                                ...
                                dislike men who are beguiled and demoralized by
                                the charms of pleasures that moment, so blinded
                                by desires, that they cannot foresee
                                indignations some dislike mens who are so
                    ...
                    <div className="button-model col-md-3 col-sm-6">
                      ...
                      >
                        <img
                          src={require("./../../images/gallery/pic2.jpeg")}
                          alt=""
                        />
                        <div className="text-center p-t20 m-b30">
                          <h4> Small-Modal</h4>
                    ...
                    <div className="button-model col-md-3 col-sm-6">
                      ...
                      >
                        <img
                          src={require("./../../images/gallery/pic3.jpeg")}
                          alt=""
                        />
                        <div className="text-center p-t20 m-b30">
                          <h4> Large-Modal</h4>
                    ...
                    <div className="button-model col-md-3 col-sm-6">
                      ...
                      >
                        <img
                          src={require("./../../images/gallery/pic4.jpeg")}
                          alt=""
                        />
                        <div className="text-center p-t20 m-b30">
                          <h4> With-form</h4>
